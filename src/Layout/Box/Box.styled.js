...
import { getWidthStyle, getFlexBasisStyle, getHeightStyle, } from '../../common/utils/style.util';
export const commonBoxStyle = css `
  ${({ display = 'block', width, height, 
// ====================
backgroundColor, color, 
// ====================
flexDirection, justifyContent, alignItems, alignContent, flexWrap, gap, rowGap, columnGap, 
// ====================
order, flexGrow, flexShrink, flexBasis, flex, alignSelf, 
// ====================
gridTemplateColumns, gridTemplateRows, padding, paddingTop, paddingBottom, paddingLeft, paddingRight, margin, marginTop, marginBottom, marginLeft, marginRight, elevation, }) => css `
      display: ${display};
      ${getWidthStyle(width)};
