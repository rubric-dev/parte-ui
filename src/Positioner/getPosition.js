 ...
 * @return {Boolean}
 */
const getFitsOnBottom = (bottomRect, viewport, viewportOffset) => {
 ...
 * @return {Boolean}
 */
const getFitsOnTop = (topRect, viewportOffset) => {
 ...
 * @return {Boolean}
 */
const getFitsOnRight = (rightRect, viewport, viewportOffset) => {
 ...
 * @return {Boolean}
 */
const getFitsOnLeft = (leftRect, viewportOffset) => {
 ...
 */
export default function getFittedPosition({ dimensions, position, targetOffset, targetRect, viewport, viewportOffset = 8, }) {
...
function getPosition({ dimensions, position, targetOffset, targetRect, viewport, viewportOffset = 8, }) {
    ...
    if (isHorizontal) {
        ...
        const fitsOnRight = getFitsOnRight(rightRect.right, viewport, viewportOffset);
        if (position === Position.LEFT) {
            if (fitsOnLeft) {
                return {
                    position,
    ...
    const bottomRectFitsOnBottom = getFitsOnBottom(bottomRect.bottom, viewport, viewportOffset);
    if (positionIsAlignedOnTop) {
        if (topRectFitsOnTop) {
            return {
                position,
